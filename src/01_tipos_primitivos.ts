...
export const nombreEstudiante: string = "Leslie Marin";       // 👈 TODO: Escribe tu nombre aquí
export const edadEstudiante: number = 17;          // 👈 TODO: Escribe tu edad aquí
export const promedioObjetivo: number = 9.60;        // 👈 TODO: Escribe tu promedio objetivo
...
export function obtenerResumenPersonal(): string {
  let estadoTexto = "MATRICULADO";
  if (estaMatriculado == false) {
    estadoTexto = "NO_MATRICULADO";
  }
...
export function formatearFichaEstudiante(
  ...
  let estadoTexto = "MATRICULADO";
  if (activo == false){estadoTexto = "RETIRADO";
  }
